...
func bloodScreen() *ui.Box {
	face1 := ui.NewImage(96, 120, loadImage("face/face0038.jpg"))
	face2 := ui.NewImage(96, 120, loadImage("face/face0108.jpg"))
	...
	screen := ui.NewBox(screenWidth, screenHeight, ui.Color("f00"))
